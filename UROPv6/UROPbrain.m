...
//        }
//        wavelet = [self.dwt singleLevelWaveletOn:wavelet ofLength:width];
//        for (x=0; x<width; x++) {
...
//        }
//        
//        wavelet = [self.dwt singleLevelWaveletOn:wavelet ofLength:height];
//        
//        for (y=0; y<height; y++) {
...
//    NSArray * data = [self.dwt getRGBAsFromImage:image atX:0 andY:0 count:area];
//    //   NSLog(@"----------------------");
//    for (i=0; i<10; i++) {
...
//        // end copy
//        // perform wavelet
//        wavelet = [self.dwt waveletOn2DArray:wavelet ofWidth:width>>k andHeight:height>>k];
...
//        
//        colorPlane = [self.dwt waveletOn2DArray:colorPlane ofWidth:width andHeight:height ofOrder:order divide:@"image"]; // change from null to image if want /2
...
//    free(colorPlane);
//    
//    //    data = [self.dwt getRGBAsFromImage:image atX:0 andY:0 count:area];
...
//            wavelet[x] = array[y*width + x];
//        }
//        wavelet = [self.dwt inverseWaveletOn:wavelet ofLength:width];
//        for (x=0; x<width; x++) {
//            array[y*width + x] = wavelet[x];
//        }
//    }
...
//        colorPlane = [self.dwt inverseOn2DArray:colorPlane ofWidth:width andHeight:height ofOrder:order multiply:@"image"]; // change from null to image if want *2
//        array      = [self.dwt putColorPlaneBackIn:colorPlane into:array ofArea:area startingIndex:n];
//    }
//    
//    
...
//        // end copy
//        // perform wavelet
//        wavelet = [self.dwt inverseOn2DArray:wavelet ofWidth:width>>k-1 andHeight:height>>k-1];
//        for (i=0; i<width*height; i++) {
//            wavelet[i] = wavelet[i] * factor;
//        }
//        // copy array over (wavelet into array)
